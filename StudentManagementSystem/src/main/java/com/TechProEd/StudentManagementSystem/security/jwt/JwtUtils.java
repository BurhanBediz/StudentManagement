...
import com.TechProEd.StudentManagementSystem.security.service.StudentDetailsImpl;
...
public class JwtUtils {
    ...
    public boolean validateJwtToken(String authToken){
        try{
            ...
            logger.error("JWT token zaman aşımı: {}");
        }
        catch (UnsupportedJwtException e){
            logger.error("Token desteklenmiyor: {}",e.getMessage());
        }
